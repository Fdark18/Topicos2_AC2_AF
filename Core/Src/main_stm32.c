 ...
 ******************************************************************************
 * @file           : main_stm32.c
 * @brief          : Main program for STM32L053R8 FreeRTOS conveyor system
 ******************************************************************************
 * @attention
 *
 ...
 * - Emergency button on PC13 (USER button)
 * - Status LED on PA5 (LD2)
 * - Error LED on PB0 (external)
 * - Piston A on PA8
 * - Piston B on PA9
 * - USART2 for debug (115200 baud)
 *
 ******************************************************************************
 */
